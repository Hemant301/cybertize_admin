...
import 'package:cybertize_admin/main.dart';
  ...
  Future<dynamic> setTokenApi(String tokenkey) async {
    ...
    try {
      ...
      final response = await client.post(
          Uri.parse(
              "https://cms.cybertize.in/cybertize-enquiry/register-token-api.php"),
          // Uri.parse(
...
Future<void> showBigPictureNotification(
  ...
  final String largeIconPath = await _downloadAndSaveFile(
      'https://cybertizeweb.com/logo-inverted-new.png', 'largeIcon');
  print(image);
